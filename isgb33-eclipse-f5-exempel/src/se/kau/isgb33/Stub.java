		...
		b.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent q) {
				...
				try (InputStream input = new FileInputStream("connection.properties")) {
					...
					MongoCollection<Document> collection = database.getCollection("hejhejhej");
					...
					/* 	 	
			          String genreInput = t.getText();
						Bson filter = Filters.in("genres", genreInput);
...
*/
					...
					while(iterator.hasNext()) {
						...
						List<String> tillbhlista = (List<String>) myDoc.get("amenities");
						area.append("Tillbehör: " );
						for(String til :tillbhlista ) {
							area.append(til + ", ");
						}
						area.append("\n\n ---------------------- \ns");
					}
